<template>
  <div class="main main-lesson main-subject">
        <div class="main-header">
            ...
            <div class="header-info">
                ...
                <div class="info-noti">
                    <img src="../assets/logo/clarity_notification-solid.svg" alt="notification">
                    <div class="dot"></div>
                </div>
            </div>
        </div> 
        ...
        <div class="main-content">
            <div class="content-header">
                ...
                <div class="header header-name">Tên môn học
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-img">Ảnh bìa
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-program">Chương trình
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-status">Trạng thái
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-create">Người tạo
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-date-create">Ngày tạo
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-modifier">Người sửa
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
                <div class="header header-last-modify">Ngày sửa cuối
                    <img src="../assets/logo/sort.svg" alt="sort">
                </div>
            ...
            <div class="content-main">
                <div class="main-item">
                    ...
                    <div class="item item-name">Tiếng Việt</div>
                    <div class="item item-img">
                        <img src="../assets/photo/paper-1.png" alt="paper-1">
                    </div>
                    <div class="item item-program">Lớp 1</div>
